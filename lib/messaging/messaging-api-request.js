...
var FirebaseMessagingRequestHandler = /** @class */ (function () {
     ...
     */
    FirebaseMessagingRequestHandler.prototype.invokeRequestHandler = function (host, path, requestData, agent) {
        return this.signedApiRequestHandler.sendRequest(host, FIREBASE_MESSAGING_PORT, path, FIREBASE_MESSAGING_HTTP_METHOD, requestData, FIREBASE_MESSAGING_HEADERS, FIREBASE_MESSAGING_TIMEOUT, agent).then(function (response) {
