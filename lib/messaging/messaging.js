...
var Messaging = /** @class */ (function () {
     ...
     */
    Messaging.prototype.sendToDevice = function (registrationTokenOrTokens, payload, options, agent) {
        var _this = this;
        ...
        return Promise.resolve()
            ...
            return _this.messagingRequestHandler.invokeRequestHandler(FCM_SEND_HOST, FCM_SEND_PATH, request, agent);
        })
            .then(function (response) {
