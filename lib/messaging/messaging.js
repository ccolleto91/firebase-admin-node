...
var Messaging = /** @class */ (function () {
     ...
     */
    Messaging.prototype.sendToDevice = function (registrationTokenOrTokens, payload, options, proxy) {
        var _this = this;
        ...
        return Promise.resolve()
            ...
            return _this.messagingRequestHandler.invokeRequestHandler(FCM_SEND_HOST, FCM_SEND_PATH, request, proxy);
        })
            .then(function (response) {
