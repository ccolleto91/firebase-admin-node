...
var HttpRequestHandler = /** @class */ (function () {
     ...
     */
    HttpRequestHandler.prototype.sendRequest = function (host, port, path, httpMethod, data, headers, timeout, agent) {
        var _this = this;
        // Convenience for calling the real _sendRequest() method with the original params.
        var sendOneRequest = function () {
            return _this._sendRequest(host, port, path, httpMethod, data, headers, timeout, agent);
        };
     ...
     * @return {Promise<object>} A promise that resolves with the response.
     */
    HttpRequestHandler.prototype._sendRequest = function (host, port, path, httpMethod, data, headers, timeout, agent) {
        var requestData;
        if (data) {
            try {
...
var SignedApiRequestHandler = /** @class */ (function (_super) {
     ...
     */
    SignedApiRequestHandler.prototype.sendRequest = function (host, port, path, httpMethod, data, headers, timeout, agent) {
        var _this = this;
        return this.app_.INTERNAL.getToken(false, agent).then(function (accessTokenObj) {
            ...
            return _super.prototype.sendRequest.call(_this, host, port, path, httpMethod, data, headersCopy, timeout, agent);
        });
    };
