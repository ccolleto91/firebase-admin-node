...
var HttpRequestHandler = /** @class */ (function () {
     ...
     */
    HttpRequestHandler.prototype.sendRequest = function (host, port, path, httpMethod, data, headers, timeout, proxy) {
        var _this = this;
        // Convenience for calling the real _sendRequest() method with the original params.
        var sendOneRequest = function () {
            return _this._sendRequest(host, port, path, httpMethod, data, headers, timeout, proxy);
        };
     ...
     * @return {Promise<object>} A promise that resolves with the response.
     */
    HttpRequestHandler.prototype._sendRequest = function (host, port, path, httpMethod, data, headers, timeout, proxy) {
        var requestData;
        if (data) {
            try {
        ...
        var agent = proxy ? new HttpsProxyAgent(proxy) : null;
        var options = {
            method: httpMethod,
            host: host,
            port: port,
...
var SignedApiRequestHandler = /** @class */ (function (_super) {
     ...
     */
    SignedApiRequestHandler.prototype.sendRequest = function (host, port, path, httpMethod, data, headers, timeout, proxy) {
        var _this = this;
        return this.app_.INTERNAL.getToken(false, proxy).then(function (accessTokenObj) {
            ...
            return _super.prototype.sendRequest.call(_this, host, port, path, httpMethod, data, headersCopy, timeout, proxy);
        });
    };
